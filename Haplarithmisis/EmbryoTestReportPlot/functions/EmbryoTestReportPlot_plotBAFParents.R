# EmbryoTestReportPlot_plotBAFParents - Function to plot the BAF data of the parents
...
EmbryoTestReportPlot_plotBAFParents <- function(Chrom, ChrLength, Origin1, Origin2, OriginSeg1, OriginSeg2, EmbryoID, Int, LabHead, Lab, Main, Ax, C){
  plot(0, ylab = LabHead, line = 3.5, col = "white", main = "", xlab = "", frame = FALSE, ylim = c(-0.1, 1.1), xlim = c(0, ChrLength), cex = 4, cex.lab = Lab, cex.main = Main, cex.axis = Ax, xaxt = "n", yaxt = "n")
