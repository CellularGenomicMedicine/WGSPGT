EmbryoTestReportPlot_plotPOZoom <-function(Chrom,dataPo,EmbryoID,Int,downcalc,upcalc,Lab,Main,Ax){
  plot(dataPo$Position[dataPo$Chr == Chrom & dataPo[,EmbryoID]>0], dataPo[dataPo$Chr == Chrom & dataPo[,EmbryoID]>0,EmbryoID], "h",xaxt="n",yaxt="n",xlab="", xlim = c(downcalc,upcalc),ylab="PO",col = "pink",frame=F, ylim = c(-1,1),cex.lab=Lab,cex.main=Main,cex.axis=Ax)
