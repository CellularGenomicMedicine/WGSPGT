# EmbryoTestReportPlot_plotLogR - Function to plot the LogRs and segmented LogRs

EmbryoTestReportPlot_plotLogR <- function(Chrom, ChrLength, logRs, SegLogRs, EmbryoID, Int, LabHead, Lab, Main, Ax, C){
  plot(0, ylab = LabHead, line = 3.5, col = "white", main = "", xlab = "", frame = FALSE, ylim = c(-1.5, 1.5), xlim = c(0, ChrLength), cex = 4, cex.lab = Lab, cex.main = Main, cex.axis = Ax, xaxt = "n", yaxt = "n")
