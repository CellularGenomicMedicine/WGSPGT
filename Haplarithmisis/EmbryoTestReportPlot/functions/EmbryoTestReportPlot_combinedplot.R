# EmbryoTestReportPlot_combinedplot - Function to plot chromosome-specific plots
...
EmbryoTestReportPlot_combinedplot <- function(script, dataHap, dataHapRaw, dataPo, BAFs, logRs, SegLogRs, PhBAF, ChrsLength, ideogram, parent, EmbryoID, outPathPlots, Chrom, Int, flip){
  ...
  # Generate a time stamp for the filename
  ...
  #Layout for plot without SNP-table
    ...
    #2 - Ideogram
    par(mar = c(5, 6, 0, 1))
    plotCyto(Chrom,BandName = TRUE, ChrsLength, ideogram)

    #3 - Ideogram zoom
    par(mar = c(5, 6, 0, 1))
    EmbryoTestReportPlot_plotCytoZoom(Chrom, BandName = TRUE, upcalc, downcalc, ideogram)
