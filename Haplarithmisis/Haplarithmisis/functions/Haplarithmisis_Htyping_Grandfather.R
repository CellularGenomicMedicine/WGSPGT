# Haplarithmisis_Htyping_Grandfather - Function for haplotyping when grandfather is referent
...
Haplarithmisis_Htyping_Grandfather <- function(script,Father,Mother,RefSampleID, Gtypes, ParScore, Window,Int,Chroms,parent,Parent1, EmbryoID){
  ...
  # Source the function for haplotyping chromosome X using grandfather
  ...
  # Phase parental genotypes based genotype inherited from referent grandfather as first
