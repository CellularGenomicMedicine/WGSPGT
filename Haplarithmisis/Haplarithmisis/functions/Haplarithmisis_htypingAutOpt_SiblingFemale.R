# Haplarithmisis_htypingAutOpt_SiblingFemale - Function to haplotyping the autosomes when female sibling is referent
...
Haplarithmisis_htypingAutOpt_SiblingFemale <- function(script, Gtypes, Father, Mother, RefSampleID, GTEmbryo, EmbryoID){
  ...
  print("*******************************************")
	...
	# Determination of parental informative SNPs, showing pattern of homozygosity in one parent and heterozygosity in the other parent
