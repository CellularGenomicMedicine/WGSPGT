# Haplarithmisis_phgrandmother - Function to phase parental genotypes using the grandmother

Haplarithmisis_phgrandmother <- function(Gtypes, parent, Parent1, Father, Mother, RefSampleID){
