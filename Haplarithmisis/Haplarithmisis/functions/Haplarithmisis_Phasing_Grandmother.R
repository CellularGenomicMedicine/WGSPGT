# Haplarithmisis_Phasing_Grandmother - Function to phase when grandmother is referent

Haplarithmisis_Phasing_Grandmother <- function(script, Father, Mother, RefSampleID, Gtypes, BAFs, parent, Parent1, EmbryoID, flip){
  ...
  # Source the function to phase using the grandmother
  source(paste(script, "analyses", "Haplarithmisis", "functions", "Haplarithmisis_Phasing_Grandmother_function.R",sep="/"))
  ...
  Parents <- Haplarithmisis_phgrandmother(Gtypes, parent, Parent1, Father, Mother, RefSampleID)
